...
close all;
clc;
%% Supplemental figure 4A, from Drifting codes (2020) Wolff et al.
...
%% Suppl. Figure 4A, right (circular mean)
figure
pos=[.98 1.02];
hold all
...
%% Suppl. Figure 4A, right (asymmetry score)
figure
pos=[.98 1.02];
hold all
...
pbaspect([1,1,1])
set(gca,'TickDir','out')
%% median split within each orientation bin
